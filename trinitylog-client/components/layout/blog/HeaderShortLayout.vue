<template>
  <div
      class="flex w-full h-full bg-stone-900 space-x-4 place-items-center bg-opacity-50 backdrop-blur justify-center">
    <div v-if="showLogo"
    ...
    <div class="text-stone-500 hover:text-stone-300 cursor-pointer">
    ...
    <div class="text-stone-500 hover:text-stone-300 cursor-pointer">
      <NuxtLink :to="'/' + blogInfo.meta.userName + '/post'">post</NuxtLink>
    </div>
    <div class="text-stone-500 hover:text-stone-300 cursor-pointer">
      <NuxtLink :to="'/' + blogInfo.meta.userName + '/project'">project</NuxtLink>
    </div>
    <div class="text-stone-500 hover:text-stone-300 cursor-pointer">
      <NuxtLink :to="'/' + blogInfo.meta.userName + '/contact'">contact</NuxtLink>
    </div>
  </div>
</template>
